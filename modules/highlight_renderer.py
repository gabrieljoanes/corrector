...
def render_highlighted_text(original_text, corrections, decisions, focus_idx=None):
    ...
    # Sort corrections in reverse order to not break offsets
    ...
    text = original_text  # Don't escape yet
    ...
    for i, corr in sorted_corrections:
        ...
        # Add surrounding spaces for clarity
        replacement = f" {replacement} "
        text = text[:start] + replacement + text[end:]

    # Escape only final HTML-safe version
